 ...
 */
package com.gvdroidframework.redis.utils;
...
public class RedisUtils {
	...
	/**
	 * 向redis中存入固定区间list，先进先出
	 * @param key
	 * @param value
	 * @param maxCount
	 */
	public void saveData(String key, String value, int maxCount) {
		listOps.leftPush(key, value);
		lTrim(key, 0L, (long)(maxCount - 1));
	}
	...
	public List<String> queryData(String key) {
		List<String> list = lRange(key, 0L, -1L);
		return list;
	}
}
