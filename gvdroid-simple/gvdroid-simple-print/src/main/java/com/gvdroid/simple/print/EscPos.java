...
import com.gvdroid.simple.print.params.*;
import com.gvdroid.simple.print.utils.SubByteString;
...
public class EscPos {
    ...
    public static void print(String template, String param) throws IOException {
        ...
        List<Map<String, Object>> othersParam = posParam.getOthers();
...
//        escPos.line(1);
        ...
        // print other title
        for (JSONObject jsonObject : posTpl.getOtherTitle()) {
            print(jsonObject);
        }


        // print others
        for (Map<String, Object> others : othersParam) {
            printOthers(others, posTpl.getOthers());
        }
